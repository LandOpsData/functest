define({
  "layersPage": {
    ...
    "enableAutomaticAttributeUpdates": "Automatsko pozivanje radnje atributa nakon ažuriranja geometrije",
    ...
    "buttonPositionsLabel": "Položaj gumba za spremanje, brisanje, natrag i poništavanje odabira",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Konfigurirajte radnje pametnog atributa za <b>${fieldname}</b>",
    ...
    "copyAttributesNote": "Onemogućavanje da bilo koja radnja ima naziv grupe bit će jednako kao i samostalno uređivanje te radnje te će ukloniti radnju za ovo polje iz odgovarajuće grupe.",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "Nema polja u bilo kojem sloju karte koji odgovara odabranoj vrsti podataka."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Zadano dopušteno odstupanje presijecanja"
  },
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Napomena: polja odabranog sloja upotrijebit će se za definiranje kriterija",
    "expressionText": "Izraz",
    "editExpressionLabel": "Uredi izraz",
    "layerAndFieldsApplyLabel": "Slojevi i polja za primjenu",
    "submitAttributeText": "Želite poslati atributnih podataka za odabrana skrivena polja?",
  ...
  "attributeActionsPage": {
    ...
    "alreadyAppliedActionMsg": "Radnja ${action} već se primjenjuje na ovo polje."
  },
  "chooseFromLayer": {
    "fieldLabel": "Polje",
