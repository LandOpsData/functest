define({
  "layersPage": {
    ...
    "enableAutomaticAttributeUpdates": "Automatisch attribuutactie na geometriedupdate oproepen",
    ...
    "buttonPositionsLabel": "Positie van de selectieknoppen Opslaan, Wissen, Terug en Wissen",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Configureer de Smart Attribute Actions voor <b>${fieldname}</b>",
    ...
    "copyAttributesNote": "Het uitschakelen van een actie met een groepsnaam zal hetzelfde effect hebben als het onafhankelijk bewerken van die actie, en zal de actie voor dit veld uit de overeenkomstige groep verwijderen.",
    ...
    "editOptionsPopup": {
      ...
      "expression": "De expressie van de geselecteerde slimme actie wordt gedefinieerd vanuit de groep. Kies een van de volgende opties om een expressie van een slimme actie te bewerken:",
  ...
  "intersectionPage": {
    ...
    "intersectingLayersLabel": "La(a)g(en) om een waarde te extraheren",
    "layerAndFieldsApplyLabel": "La(a)g(en) en veld(en) om geëxtraheerde waarde toe te passen",
    ...
    "noLayersMessage": "Geen veld gevonden in een laag van de kaart dat overeenkomt met het geselecteerde gegevenstype."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Standaardtolerantie kruising"
  },
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Opmerking: velden van geselecteerde lagen zullen worden gebruikt om criteria te definiëren",
    "expressionText": "Expressie",
    "editExpressionLabel": "Expressie bewerken",
    "layerAndFieldsApplyLabel": "Lagen en velden om op toe te passen",
    "submitAttributeText": "Attribuutgegevens indienen voor de geselecteerde verbogen veld(en)?",
    ...
    "deleteGroupPopupMsg": "Als de groep wordt verwijderd, wordt de expressie verwijderd van alle acties in de/het geassocieerde veld(en).",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Als de groep wordt verwijderd, wordt het attribuut verwijderd uit alle geassocieerde velden.",
    "alreadyAppliedActionMsg": "${action}-actie al op dit veld toegepast."
  },
  "chooseFromLayer": {
    "fieldLabel": "Veld",
    "valueLabel": "Waarde",
