define({
  "layersPage": {
    ...
    "enableAutomaticAttributeUpdates": "Apelează automat Acțiunea atributului după actualizarea geometriei",
    ...
    "buttonPositionsLabel": "Poziția butoanelor Salvare, Ștergere, Înapoi și Golire selecție",
    ...
    "toleranceErrorMsg": "Valoare de toleranță a intersecției implicite nevalabile"
  },
  "editDescriptionPage": {
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Configurați acțiunile atributelor inteligente pentru <b>${fieldname}</b>",
    ...
    "editOptionsPopup": {
      ...
      "editAttributeGroup": "Acțiunea atribut selectată este definită de la grup. Selectați una dintre următoarele opțiuni pentru a edita acțiunea atribut:",
      "expression": "Expresia acțiunii inteligente selectate este definită de la grup. Selectați una dintre următoarele opțiuni pentru a edita expresia acțiunii inteligente:",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "Niciun câmp găsit în niciun strat al hărții nu corespunde tipului de date selectat."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Toleranță intersecție implicită"
  },
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Notă: câmpurile stratului selectat vor fi utilizate pentru a defini criteriile",
    ...
    "submitAttributeText": "Transmitere date atribut pentru câmpurile ascunse selectate?",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Ștergerea grupului va cauza eliminarea acțiunii atribut din toate câmpurile asociate.",
    "alreadyAppliedActionMsg": "Acțiune a${action} a fost deja aplicată acestui câmp."
  },
  "chooseFromLayer": {
    "fieldLabel": "Câmp",
    "valueLabel": "Valoare",
