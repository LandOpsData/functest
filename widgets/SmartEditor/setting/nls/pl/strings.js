define({
  "layersPage": {
    ...
    "enableAutomaticAttributeUpdates": "Automatycznie wywołuj działanie atrybutu po aktualizacji geometrii",
    ...
    "buttonPositionsLabel": "Pozycja przycisków Zapisz, Usuń, Wstecz i Wyczyść wybór",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Skonfiguruj działania inteligentnych atrybutów dla pola <b>${fieldname}</b>",
    ...
    "copyAttributesNote": "Wyłączenie jakiegokolwiek działania mającego nazwę grupy odnosi taki sam skutek, co niezależna edycja tego działania i powoduje usunięcie działania dla tego pola z odpowiedniej grupy.",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "W żadnej warstwie mapy nie znaleziono pola pasującego do wybranego typu danych."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Domyślna tolerancja przecięcia"
  },
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Uwaga: Wybrane pola warstwy zostaną użyte do zdefiniowania kryteriów",
    "expressionText": "Wyrażenie",
    "editExpressionLabel": "Edytuj wyrażenie",
    "layerAndFieldsApplyLabel": "Warstwy i pola zastosowania",
    "submitAttributeText": "Czy przesłać dane atrybutów dla wybranych ukrytych pól?",
    ...
    "deleteGroupPopupMsg": "Usunięcie grupy spowoduje usunięcie wyrażenia z działania wszystkich powiązanych pól.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Usunięcie grupy spowoduje usunięcie działania atrybutu z wszystkich powiązanych pól.",
    "alreadyAppliedActionMsg": "Działanie ${action} zostało już zastosowane względem tego pola."
  },
  "chooseFromLayer": {
    "fieldLabel": "Pole",
    "valueLabel": "Wartość",
