define({
  "layersPage": {
    ...
    "buttonPositionsLabel": "Posição dos botões Guardar, Eliminar, Regressar e Limpar Seleções",
  ...
  "actionPage": {
    ...
    "copyAttributesNote": "A desativação de qualquer ação que tenha o nome do grupo terá o mesmo efeito que a edição dessa ação de forma independente e irá remover a ação para este campo do respetivo grupo.",
