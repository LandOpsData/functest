define({
  "layersPage": {
    ...
    "enableAutomaticAttributeUpdates": "Kutsu automaattisesti ominaisuustietotoimintoa geometrian päivityksen jälkeen",
    ...
    "buttonPositionsLabel": "Tallenna-, Poista-, Takaisin- ja Tyhjennä valinta -painikkeiden sijainti",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Määritä Älykkäät ominaisuudet -toiminnot kentälle <b>${fieldname}</b>",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "Yhdestäkään kartan karttatasosta ei löytynyt kenttää, joka vastaa valittua tietotyyppiä."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Leikkauskohdan toleranssin oletusarvo"
  },
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Huomautus: valitun karttatason kenttiä käytetään ehtojen määritykseen",
    ...
    "submitAttributeText": "Lähetetäänkö valittujen piilotettujen kenttien ominaisuustietoaineisto?",
  ...
  "attributeActionsPage": {
    ...
    "alreadyAppliedActionMsg": "Toimintoa ${action} on jo käytetty tässä kentässä."
  },
  "chooseFromLayer": {
    "fieldLabel": "Kenttä",
    "valueLabel": "Arvo",
