define({
  "layersPage": {
    ...
    "enableAutomaticAttributeUpdates": "Richiama automaticamente Azione attributo dopo l’aggiornamento della geometria",
    ...
    "buttonPositionsLabel": "Posizione dei pulsanti Salva, Elimina, Indietro e Cancella selezione",
  ...
  "actionPage": {
    ...
    "copyAttributesNote": "La disattivazione di qualsiasi azione con nome gruppo sarà uguale alla modifica dell'azione in modo indipendente e rimuoverà l'azione per questo campo dal rispettivo gruppo.",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "Nessun campo trovato in nessun layer della mappa che corrisponde al tipo di dati selezionato."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Tolleranza intersezione predefinita"
  },
  "smartActionsPage": {
    ...
    "submitAttributeText": "Inviare dati attributo per i campi nascosti selezionati?",
