define({
  "layersPage": {
    ...
    "toleranceErrorMsg": "Érvénytelen alapértelmezés szerinti metszéspont-tolerancia érték"
  },
  "editDescriptionPage": {
  ...
  "actionPage": {
    ...
    "copyAttributesNote": "A csoportnévvel rendelkező művelet letiltása ugyanaz, mint az adott művelet független módosítása, és eltávolítja a mezőre vonatkozóan a műveletet az adott csoportból.",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "Nem található a térképnek olyan rétege, amely egyezne a kiválasztott adattípussal."
  },
  "presetAll": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Alapértelmezett metszéspont-tolerancia"
  },
  "smartActionsPage": {
    ...
    "submitAttributeText": "Elküldi a kiválasztott rejtett mező(k)re vonatkozó attribútumadatokat?",
